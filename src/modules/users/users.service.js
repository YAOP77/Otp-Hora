...
async function createUser(payload) {
  ...
  return {
    user: createdUser,
    auth: {
      access_token: signUserAccessToken(createdUser.user_id),
      refresh_token: signUserRefreshToken(createdUser.user_id),
      token_type: 'Bearer',
    },
  };
}
...
async function refreshUserToken(payload) {
  ...
  return {
    access_token: signUserAccessToken(user.user_id),
    refresh_token: signUserRefreshToken(user.user_id),
    token_type: 'Bearer',
  };
}
